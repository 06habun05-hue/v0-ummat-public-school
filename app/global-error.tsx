...
const _plusJakarta = Plus_Jakarta_Sans({ subsets: ["latin"], variable: '--font-heading', weight: ['400', '500', '600', '700'] })
...
export default function GlobalError({
  ...
  useEffect(() => {
    ...
    console.error('Ummat Systems Global Error Boundary caught:', error)
  }, [error])

  return (
    <html lang="en" className={`${_geist.variable} ${_geistMono.variable} ${_plusJakarta.variable}`}>
              ...
              <CardHeader className="space-y-4 pb-6">
                ...
                <div>
                  ...
                  <CardDescription className="text-sm font-medium mt-2">
                    The application encountered an unexpected layout-level runtime error.
                  </CardDescription>
                </div>
              </CardHeader>
